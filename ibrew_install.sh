...
if [[ -z "${HOMEBREW_ON_LINUX-}" ]]; then
  ...
  HOMEBREW_CORE_DEFAULT_GIT_REMOTE="http://mirrors.ustc.edu.cn/homebrew-core.git"
  ...
  HOMEBREW_CORE_DEFAULT_GIT_REMOTE="http://mirrors.ustc.edu.cn/linuxbrew-core.git"
...
HOMEBREW_BREW_DEFAULT_GIT_REMOTE="http://mirrors.ustc.edu.cn/brew.git"
